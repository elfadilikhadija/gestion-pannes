...
$divisions_result = mysqli_query($con, $divisions_query);
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <h1 class="text-center">créer compte </h1>
    <form method="POST" class="" action="create_account.php">
        ...
        <select class="form-control" id="division_id" name="division_id" required>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($divisions_result)) : ?>
                                <option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                            <?php endwhile; ?>
                        </select>
              </div>

        <button class='btn btn-primary' type="submit">Creér un nouveau utilisateur</button>
    </form>
</main>
